...
const translations = {
  fr: {
    ...
    hero_pitch: "Ingénieur logiciel & DevOps avec plus de 5 ans d'expérience en production et titulaire d'un Master en informatique. J'interviens sur la conception d'APIs et d'applications web robustes (Python, TypeScript, React) et l'automatisation d'infrastructures Cloud (Docker, CI/CD, Linux) avec une exigence constante de clarté, de sécurité et de maintenabilité.",
  ...
  en: {
    ...
    hero_pitch: "Software & DevOps Engineer with 5+ years of production experience and a Master's Degree in Computer Systems. I help teams and businesses build reliable web applications, robust APIs (Python, TypeScript, React), and automated Cloud infrastructure (Docker, CI/CD, Linux) with a constant focus on code clarity and long-term maintainability.",
